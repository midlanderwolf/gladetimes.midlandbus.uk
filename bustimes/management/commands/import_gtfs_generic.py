...
class Command(BaseCommand):
    def add_arguments(self, parser):
        ...
        parser.add_argument("noc", help="Operator NOC code")
        parser.add_argument(
            "--url",
    ...
    def handle(self, source_name, noc, url=None, filename=None, stop_prefix=None, *args, **options):
        if not filename:
        ...
        operator, _ = Operator.objects.get_or_create(noc=noc)
        operator.timezone = agency_timezone
        operator.save(update_fields=["timezone"])
